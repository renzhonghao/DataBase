...
/* Created on:     2016/11/30 21:13:31                          */
/*==============================================================*/
...
create table CourseManage (
   Cno                  char(2)              not null,
   Teno                 char(4)              not null,
   Cono                 char(4)              not null,
   classroom            varchar(30)          null,
   constraint PK_COURSEMANAGE primary key nonclustered (Cno, Teno, Cono)
)
go
...
create table Macourse (
   ...
   constraint PK_MACOURSE primary key nonclustered (Cno, Cono, Mno, Msemester)
)
go
...
create table Major (
   ...
   constraint PK_MAJOR primary key nonclustered (Cno, Mno)
)
go
...
create table SeCourse (
   ...
   score                float                null,
   S_score              float                null,
   constraint PK_SECOURSE primary key nonclustered (Cno, Teno, Cono, Sno, semester)
)
go
...
create table Teacher (
   ...
   constraint PK_TEACHER primary key nonclustered (Cno, Teno)
)
go
